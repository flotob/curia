...
export async function GET(request: NextRequest) {
  ...
  // Get the Common Ground URL from environment (this should be the parent page URL)
  const commonGroundUrl = process.env.COMMON_GROUND_BASE_URL || 'https://app.commonground.wtf';
  
  // Create response with redirect to Common Ground
