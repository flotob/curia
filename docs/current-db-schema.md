...
DROP FUNCTION IF EXISTS "board_has_lock_gating";;
CREATE FUNCTION "board_has_lock_gating" (IN "board_id" integer) RETURNS bool LANGUAGE plpgsql AS '
    DECLARE
      lock_config JSONB;
    BEGIN
...
DROP FUNCTION IF EXISTS "get_board_lock_ids";;
CREATE FUNCTION "get_board_lock_ids" (IN "board_id" integer) RETURNS _int4 LANGUAGE plpgsql AS '
    DECLARE
      lock_config JSONB;
      lock_ids INTEGER[];
    BEGIN
